---
title: "Quarter-End Pipeline Slippage: 5-Step Emergency Response Guide"
emoji: "🔬"
type: "tech"
...
- **Download**: [Diagnosis Checklist (CSV)](/data/diagnosis-checklist.csv) | [Action Plan Template (CSV)](/data/action-plan-template.csv) | [Daily Review Template (CSV)](/data/daily-review-template.csv)
</div>
...
1. **How to diagnose** pipeline health in under 24 hours using a 15-point checklist
2. **How to triage** deals into Red/Yellow/Green buckets and reallocate resources
3. **How to execute** a concentrated 2-week offensive with daily stand-ups
4. **How to rebuild** pipeline through accelerated lead nurturing
5. **How to analyze** what went wrong and prevent future slippage
...
- Salesforce State of Sales 2024 ([source](https://www.salesforce.com/resources/research-reports/state-of-sales/))
- HubSpot Sales Trends 2024 ([source](https://www.hubspot.com/sales/trends))
...
**Tool Integration**: Use [Optifai Pipeline Health Dashboard](/media/articles/pipeline-health-dashboard) to automate Red/Yellow/Green classification.
...
**Deal Name**: [Deal A - Acme Corp]
**Size**: $400K
**Priority**: 🔴 Highest
**Owner**: Rep 1 + Manager Support
**Days to Close**: 6

**Blocker**: Legal review stuck for 21 days
**Root Cause**: Security questions about data residency
...
**Attendees**: All reps + managers

**Agenda**:
1. **Yesterday's wins** (30 sec per person)
   - "Closed Deal D ($200K)"
   - "Got Legal approval for Deal A"
2. **Today's plan** (30 sec per person)
   - "Calling Acme CFO to unblock budget"
   - "Sending revised proposal to Deal B"
3. **Blockers** (2 min total)
...
| Week 2 | Follow-up: Webinar recording + case study | Email | 100 attendees |
| Week 3 | Personalized outreach: "Noticed you work in [industry]" | LinkedIn DM | 20 engaged leads |
| Week 4 | Demo offer: "See how [Company X] solved [pain]" | Email | 5-10 qualified opps |
...
**Attendees**: Sales team + RevOps + Manager
**Duration**: 60 min
**Facilitator**: Neutral party (not manager)

**Agenda**:

1. **What went well?** (15 min)
   - Which Red deals did we save?
   - What actions were most effective?
   - Who went above and beyond?

2. **What went wrong?** (20 min)
   - Why did deals slip in the first place?
   - What early warning signs did we miss?
   - What could we have done differently?

3. **What will we change?** (15 min)
   - Process improvements (e.g., weekly pipeline reviews)
...
**File**: [diagnosis-checklist.csv](/data/diagnosis-checklist.csv)

**Purpose**: Score every deal using the 15-point checklist.

**How to Use**:
1. Download CSV
2. Add one row per deal
3. Score each criterion (1, 0.5, or 0)
4. Total score determines Red/Yellow/Green
5. Sort by priority (deal size × score)
...
**File**: [action-plan-template.csv](/data/action-plan-template.csv)

**Purpose**: Daily action plan for each Red deal.

**How to Use**:
1. Download CSV
2. Create one plan per Red deal
3. List daily actions (Days 1-6)
4. Assign owner and success metric
...
**File**: [daily-review-template.csv](/data/daily-review-template.csv)

**Purpose**: Track daily stand-up outcomes.

**How to Use**:
1. Download CSV
2. Fill out daily (after 9 AM stand-up)
3. Log yesterday's wins, today's plan, blockers
4. Update Red/Yellow/Green status
...
**Recommended**:
- [Optifai Pipeline Health Dashboard](/media/articles/pipeline-health-dashboard) for automated Red/Yellow/Green classification
...
1. **Clear frameworks** (not ad-hoc heroics)
2. **Speed of execution** (24-hour diagnosis, not 7-day analysis paralysis)
3. **Team coordination** (daily stand-ups, not weekly check-ins)
4. **Prevention mindset** (learning from each crisis to avoid the next)

### Next Steps

**If you're in crisis mode right now**:
1. Download the templates (↑ above)
2. Start Step 1 (Diagnosis) immediately
3. Schedule tomorrow's 9 AM stand-up

**If you're planning ahead**:
1. Implement prevention strategies (weekly reviews, MAPs, exec engagement)
2. Bookmark this playbook for future reference
3. Share with your team (so everyone knows the plan)

### Related Resources

- **[Pipeline Health Benchmark 2025](/media/articles/pipeline-health-dashboard)**: Industry benchmarks for sales cycle, win rates, and deal velocity
- **[CRM Comparison 2025](/benchmarks/2025-mid-market-sales-ops)**: Optifai vs HubSpot vs Salesforce (coming soon)
- **[New Deal Acceleration Playbook](/playbooks/new-deal-acceleration)**: How to speed up deals before they slip (coming Q1 2026)
...
**Feedback**: Did this playbook help you recover a deal? [Share your story](mailto:feedback@optif.ai) (we'll feature successful case studies in future updates).

**Download All Templates**: [ZIP file with all 3 CSV templates](/data/quarter-end-slippage-templates.zip)
