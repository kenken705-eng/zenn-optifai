---
title: "ARR Is a Vanity Metric. Welcome to Revenue Velocity."
emoji: "💡"
type: "idea"
...
Since there's **no statutory definition** of ARR in accounting standards ([Capchase, 2025](https://www.capchase.com/blog/arr-vs-mrr-navigating-saas-revenue-tracking)), companies manipulate it constantly:
...
- AI-native SaaS companies: **$300K-600K ARR per employee** ([Maxio, 2025](https://www.maxio.com/blog/the-most-important-saas-metrics))
...
This formula is [widely used in SaaS](https://www.pipedrive.com/en/blog/sales-velocity) to measure pipeline efficiency and revenue generation speed.
...
- Higher win rate = less wasted effort
...
Now improve **each lever by just 20%**:

```
120 opportunities × $1,200 deal size × 24% win rate ÷ 48 days = $720/day
```

**That's a 2.16× improvement** from 20% gains across the board.
...
**Company B: Same ARR, High Velocity**
```
200 opps × $1,000 ASP × 25% win rate ÷ 30 days = $1,667/day
Annual: $608K
```

Both companies show **$2M ARR** in a board deck (carried over from last year).
...
- **[Lead scoring](/media/articles/lead-scoring-guide)** (prioritize high-intent prospects)
  - Score by firmographic fit + engagement signals
  - Learn how to [set up lead scoring in your CRM](/media/articles/lead-scoring-guide)
...
**Metrics to track:**
- Time in each [pipeline stage](/media/articles/sales-pipeline-management-guide) (Qualification → Demo → Proposal → Close)
- Stage conversion rates
- Percentage of deals stuck >30 days
- Learn more about [optimizing your sales pipeline](/media/articles/sales-pipeline-management-guide)
...
Revenue Operations used to mean: "[Keep Salesforce clean and run reports](/media/articles/why-your-crm-is-making-you-slower)."
